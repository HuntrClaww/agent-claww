...
- [ ] Prototype Gemini 2.5 Flash Image avatar generation against the existing BYOK key infra (chain tier 1)
- [ ] Prototype Cloudflare Workers AI avatar generation (chain tier 2)
