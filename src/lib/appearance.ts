...
const MODE_TOKENS: Record<ThemeMode, Record<string, string>> = {
  dark: {
    '--surface-base': '#0f172a',
    '--surface-panel': 'rgba(15, 17, 26, 0.82)',
    '--surface-raised': 'rgba(24, 26, 38, 0.82)',
    '--surface-border': 'rgba(255, 255, 255, 0.08)',
    '--text-primary': '#f1f5f9',
    '--text-muted': '#94a3b8',
    '--glass-tint': 'rgba(255, 255, 255, 0.07)',
    '--glass-tint-soft': 'rgba(6, 8, 14, 0.55)',
  ...
  oled: {
    ...
    '--surface-base': '#000000',
    '--surface-panel': 'rgba(6, 6, 8, 0.85)',
    '--surface-raised': 'rgba(14, 14, 18, 0.85)',
    '--surface-border': 'rgba(255, 255, 255, 0.10)',
    '--text-primary': '#fafafa',
    '--text-muted': '#a1a1aa',
    '--glass-tint': 'rgba(255, 255, 255, 0.05)',
    '--glass-tint-soft': 'rgba(0, 0, 0, 0.6)',
